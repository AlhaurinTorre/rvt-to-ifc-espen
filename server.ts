    ...
    if (process.env.GOOGLE_API_KEY) {
      try {
        const response = await ai.models.generateContent({
          ...
          Devuelve estrictamente un arreglo JSON limpio sin comentarios explicativos de ningún tipo. Para cada objeto infiere o busca dimensiones aproximadas lógicas en metros.
          Esquema obligatorio:
